...
class A(avl.Object):
    ...
    def __init__(self, name : str, parent : avl.Component) -> None:
        ...
        self.a = avl.Int32(0, fmt=hex)

        # TODO: update to print as int (unless 0 - print "N/A")
        self.b = avl.Logic(0, width=4, fmt=lambda x: str(x) if x != 0 else "N/A")
...
class Env(avl.Env):
    ...
    def __init__(self, name : str, parent : avl.Component) -> None:
        ...
        self.port.connect(self.trace.item_port)
    ...
    async def task2(self):
        ...
        # TODO : Transpose
        self.A.set_table_fmt(transpose = True)
